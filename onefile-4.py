...
"""
Skip the arg builder and manually populate args
"""
...
def main(args):
    ...
    builder_args = BuilderArgs(
        checkpoint_path=Path('/home/jackkhuu/.torchchat/model-cache/meta-llama/Meta-Llama-3.1-8B-Instruct/model.pth'), 
        device='cuda',
        params_table='Meta-Llama-3.1-8B',
    )
    ...
    speculative_builder_args.checkpoint_path = None

    tokenizer_args = TokenizerArgs(
        tokenizer_path=Path('/home/jackkhuu/.torchchat/model-cache/meta-llama/Meta-Llama-3.1-8B-Instruct/tokenizer.model'),
        is_tiktoken=True)
